...
public class FourByFourManager {
    /**
     * The
     * static instance of
     * this class
     */
    private static final FourByFourManager INSTANCE = new FourByFourManager();
    private final List<IRecipe> recipes = Lists.newArrayList();

    private FourByFourManager() {
     ...
     * this class
     */
    public static FourByFourManager getInstance() {
