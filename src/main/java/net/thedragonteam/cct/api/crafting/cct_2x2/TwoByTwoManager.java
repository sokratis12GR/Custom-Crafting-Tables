...
public class TwoByTwoManager {
    /**
     * The
     * static instance of
     * this class
     */
    private static final TwoByTwoManager INSTANCE = new TwoByTwoManager();
    private final List<IRecipe> recipes = Lists.newArrayList();

    private TwoByTwoManager() {
     ...
     * this class
     */
    public static TwoByTwoManager getInstance() {
