...
import net.thedragonteam.cct.api.crafting.cct_6x6.SlotCrafting;
...
public class ContainerSixBySix extends ContainerTableBase {
    ...
    public ContainerSixBySix(InventoryPlayer playerInventory, TileEntitySixBySix tile) {
        ...
        this.addSlotToContainer(new SlotCrafting(playerInventory.player, this.craftMatrix, this.craftResult, 0, 150, 63));
        ...
        for (int l = 0; l < ROW_SLOTS; ++l)
            this.addSlotToContainer(new Slot(playerInventory, l, 8 + l * ITEM_BOX, 196));
    ...
    public void onCraftMatrixChanged(IInventory inventoryIn) {
        this.craftResult.setInventorySlotContents(0, SixBySixManager.getInstance().findMatchingRecipe(this.craftMatrix, this.world));
    }
