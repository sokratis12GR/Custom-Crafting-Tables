...
import net.thedragonteam.cct.api.crafting.cct_1x1.SlotCrafting;
...
public class ContainerOneByOne extends ContainerTableBase {
    ...
    public void onCraftMatrixChanged(IInventory inventoryIn) {
        this.craftResult.setInventorySlotContents(0, OneByOneManager.getInstance().findMatchingRecipe(this.craftMatrix, this.world));
    }
