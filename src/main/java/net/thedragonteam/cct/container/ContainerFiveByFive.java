...
import net.thedragonteam.cct.api.crafting.cct_5x5.SlotCrafting;
...
public class ContainerFiveByFive extends ContainerTableBase {
    ...
    public ContainerFiveByFive(InventoryPlayer playerInventory, TileEntityFiveByFive tile) {
    ...
    public void onCraftMatrixChanged(IInventory inventoryIn) {
        this.craftResult.setInventorySlotContents(0, FiveByFiveManager.getInstance().findMatchingRecipe(this.craftMatrix, this.world));
    }
