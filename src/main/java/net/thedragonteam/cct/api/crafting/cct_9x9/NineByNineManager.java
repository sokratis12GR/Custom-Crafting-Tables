...
public class NineByNineManager {
    /**
     * The
     * static instance of
     * this class
     */
    private static final NineByNineManager INSTANCE = new NineByNineManager();
    private final List<IRecipe> recipes = Lists.newArrayList();

    private NineByNineManager() {
     ...
     * this class
     */
    public static NineByNineManager getInstance() {
