...
public class TenByTenManager {
    /**
     * The
     * static instance of
     * this class
     */
    private static final TenByTenManager INSTANCE = new TenByTenManager();
    private final List<IRecipe> recipes = Lists.newArrayList();

    private TenByTenManager() {
     ...
     * this class
     */
    public static TenByTenManager getInstance() {
