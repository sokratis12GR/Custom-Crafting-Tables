...
import net.thedragonteam.cct.api.crafting.cct_3x3.SlotCrafting;
...
public class ContainerThreeByThree extends ContainerTableBase {
    ...
    public void onCraftMatrixChanged(IInventory inventoryIn) {
        this.craftResult.setInventorySlotContents(0, ThreeByThreeManager.getInstance().findMatchingRecipe(this.craftMatrix, this.world));
    }
