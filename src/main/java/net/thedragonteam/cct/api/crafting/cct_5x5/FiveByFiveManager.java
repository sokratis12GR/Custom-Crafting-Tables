...
public class FiveByFiveManager {
    /**
     * The
     * static instance of
     * this class
     */
    private static final FiveByFiveManager INSTANCE = new FiveByFiveManager();
    private final List<IRecipe> recipes = Lists.newArrayList();

    private FiveByFiveManager() {
     ...
     * this class
     */
    public static FiveByFiveManager getInstance() {
