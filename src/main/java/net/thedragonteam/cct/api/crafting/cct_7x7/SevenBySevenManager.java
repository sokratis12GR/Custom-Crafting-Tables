...
public class SevenBySevenManager {
    /**
     * The
     * static instance of
     * this class
     */
    private static final SevenBySevenManager INSTANCE = new SevenBySevenManager();
    private final List<IRecipe> recipes = Lists.newArrayList();

    private SevenBySevenManager() {
     ...
     * this class
     */
    public static SevenBySevenManager getInstance() {
