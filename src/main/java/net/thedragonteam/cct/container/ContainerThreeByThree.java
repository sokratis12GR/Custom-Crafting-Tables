...
public class ContainerThreeByThree extends ContainerTableBase {
    ...
    public ContainerThreeByThree(InventoryPlayer playerInventory, TileEntityThreeByThree tile) {
        super(tile, RECIPE_SLOTS, MAIN_INVENTORY_SLOTS, FULL_INVENTORY_SLOTS);
        this.world = tile.getWorld();
        this.addSlotToContainer(new BaseSlotCrafting(BaseCraftingManager.getThreeByThree(),playerInventory.player, this.craftMatrix, this.craftResult, 0, 124, 35));
    ...
    public void onCraftMatrixChanged(IInventory inventoryIn) {
        this.craftResult.setInventorySlotContents(0, BaseCraftingManager.getThreeByThree().findMatchingRecipe(this.craftMatrix, this.world));
    }
