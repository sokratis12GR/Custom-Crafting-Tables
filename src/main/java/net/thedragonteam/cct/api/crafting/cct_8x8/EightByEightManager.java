...
public class EightByEightManager {
    /**
     * The
     * static instance of
     * this class
     */
    private static final EightByEightManager INSTANCE = new EightByEightManager();
    private final List<IRecipe> recipes = Lists.newArrayList();

    private EightByEightManager() {
     ...
     * this class
     */
    public static EightByEightManager getInstance() {
