...
public class SixBySixManager {
    /**
     * The
     * static instance of
     * this class
     */
    private static final SixBySixManager INSTANCE = new SixBySixManager();
    private final List<IRecipe> recipes = Lists.newArrayList();

    private SixBySixManager() {
     ...
     * this class
     */
    public static SixBySixManager getInstance() {
